...
<!-- banner & block -->
    ...
    <div class="col-md-6 col-sm-4 height-full">
        <div class="height-full">
            ...
            <div class="col-md-6 col-xs-12 height-half animated fadeInDown"><div class="block height-full men"><a href="collections.php" class="info animated fadeInDown"><h3>160 días</h3><span>Construyendo la Piramide</span></a></div></div>
