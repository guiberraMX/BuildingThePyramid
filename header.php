...
<title>Pyramid Project | Puebla, MX</title>
...
<nav class="navbar  navbar-inverse navbar-fixed-top" role="navigation">
  <div class="clearfix">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php"><img src="images/logo.png"  alt="logo"><h1 class="hide">Aqua Fashion leading brand of london and paris</h1></a>
    </div>
    ...
    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav">        
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="collections.php">Men</a></li>
            <li><a href="collections.php">Women</a></li>
            <li><a href="collections.php">Gifts</a></li>            
          </ul>
        </li>
      ...
      <form class="navbar-form navbar-left searchbar" role="search">
        <div class="form-group">
          <input type="text" class="form-control" placeholder="artistas, titulos, generos, etc...">
        </div>
